...
App.Views.catering = (function () {
  ...
  function startScreen() {
    ...
    return '<div class="banner">' +
      ...
      (last ? '<h2 class="section-title">' + U.icon('history') + ' Last gig out</h2>' +
        '<div class="card">' +
  ...
  function loadTab(ev) {
        ...
        '<div class="row row-between">' +
          '<div class="grow truncate mr8">' +
            ...
            '<span class="row mt4" style="flex-wrap:wrap;gap:4px">' +
              U.tag(brandLabel, l.tagColor, l.tagStyle) +
    ...
    return headerBtns +
      ...
      (editable
        ...
        : '<p class="muted mt12" style="text-align:center;font-size:12px">Counts are locked while out at the gig. Track returns in Pack Down.</p>');
  }
        ...
        '<div class="row row-between">' +
          '<div class="grow truncate mr8">' +
            ...
            '<div class="row mt4" style="gap:4px">' +
              U.tag(brandLabel, l.tagColor || 'yellow', l.tagStyle) +
  ...
  /* Plain Text Manifest Modal (for SMS / WhatsApp / Notepad) */
      ...
      return '<div class="pack-row" id="p-line-' + l.itemId + '">' +
        '<div class="row row-between">' +
          '<div class="grow truncate mr8">' +
            ...
            '<div class="row mt4" style="gap:4px">' +
              (brandLabel ? U.tag(brandLabel, it.tagColor, it.tagStyle) : '') +
  ...
  function onAct(act, el) {
    ...
    if (act === 'close-event') {
        ...
        '<div class="mb12">' +
          ...
          '<div class="list mb8">' + missingDurable.map(function (l) {
            return '<div class="item"><span class="grow truncate">' +
              ...
              U.tag(l.brand || l.tagLabel, l.tagColor, l.tagStyle) + '</div>';
          }).join('') + '</div>' +
      ...
      U.openSheet('Finish ' + ev.name,
        ...
        missingDurableHtml +
        usedSuppliesHtml +
        '<button type="button" class="btn btn-primary" data-act="confirm-close">Finish and file into ledger</button>' +
